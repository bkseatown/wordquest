  ...
  function bindEvents() {
    ...
    el.settings.addEventListener("click", function () {
      ...
      if (window.CSBuildBadge && typeof window.CSBuildBadge.open === "function") {
        ...
        setCoachLine("Build controls opened. Use Force update now if this page is stale.");
        return;
      }
      setCoachLine("Build controls unavailable. Reload this page to restore update actions.");
    });
